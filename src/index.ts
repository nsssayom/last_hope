...
import {
  ...
  userValidation,
  existancialValidation,
} from "./schema/userValidators";
...
createConnection()
  .then(async (connection) => {
    ...
    app.get("/auth/:phone", async (req: Request, res: Response) => {
      const phoneNumber = req.params.phone;
      const user = await userRepository.find({ phone: phoneNumber });
    ...
    app.post(
      "/validate",
      validate(existancialValidation, {}),
      async (req: Request, res: Response) => {
